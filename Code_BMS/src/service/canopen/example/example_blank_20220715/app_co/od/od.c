...
#include "app_anti_theft.h"
#include "app_fota_init.h"
...
static CO_Object co_od_list[]=
{
		...
		{.index = 0x2001, .sub_number = 1, .subs = obj_0x2001_boot_slave_para},
		{.index = 0x2100, .sub_number = 2, .subs = anti_theft_obj},
		{.index = 0x2110, .sub_number = 3, .subs = obj_2110_maintnc},
		{.index = 0x2120, .sub_number = 2, .subs = obj_2120_throttle},
		{.index = 0x2130, .sub_number = 1, .subs = obj_2130_acc_profile_mode},
		{.index = 0x2140, .sub_number = 1, .subs = obj_2140_maximum_speed},


		{.index = 0x3FF7, .sub_number = 3, .subs = obj_3FF7_test_mapping_tpdo},
		{.index = 0x3FF8, .sub_number = 1, .subs = obj_3FF8_test_expe_sdo},
		{.index = 0x3FF9, .sub_number = 1, .subs = obj_3FF9_test_normal_sdo},
