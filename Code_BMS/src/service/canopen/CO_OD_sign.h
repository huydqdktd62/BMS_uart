...
/* Set function*/
static inline void CO_OD_SIGN_set_crc16_comm_para(CO_OD_Sign* this, uint16_t crc16)
{
	this->crc_16_comm = crc16;
}
static inline void CO_OD_SIGN_set_crc16_app_para(CO_OD_Sign* this, uint16_t crc16)
{
	this->crc_16_app = crc16;
}
static inline void CO_OD_SIGN_set_sw_ver(CO_OD_Sign* this, uint32_t sw_ver)
{
	this->sw_ver = sw_ver;
}
...
/* Get function*/
static inline uint16_t CO_OD_SIGN_get_crc16_comm_para(CO_OD_Sign* this)
{
	return this->crc_16_comm;
}
static inline uint16_t CO_OD_SIGN_get_crc16_app_para(CO_OD_Sign* this)
{
	return this->crc_16_app;
}
static inline uint32_t CO_OD_SIGN_get_sw_ver(CO_OD_Sign* this)
{
	return this->sw_ver;
}
