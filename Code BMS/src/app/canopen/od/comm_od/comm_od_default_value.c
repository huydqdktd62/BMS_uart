...
#define DEFAULT__1005__SYNC_GEN							CO_SYNC_GEN /*CO_SYNC_GEN*/		/*	Producer sync: Set CO_SYNC_GEN            -> For PMU/BSS_MASTER
...
/*  */
#define DEFAULT__1008__DEVICE_NAME						{'S','E','L','E','X','_','M','B','S'}	/*(12 byte)*/
...
/* SDO client */
#define DEFAULT__103200__SDO_CLI_SYNC_TRANS_TYPE			(1)					//<< Set according to synchronous scheduled
																			//   Set 0 if you want disable sync mode, switch to always communication mode
#define DEFAULT__103201__SDO_CLI_SYNC_MASK_REGISTER		(0x00000003)		//<< Set according to synchronous scheduled, default: 0x00000000
