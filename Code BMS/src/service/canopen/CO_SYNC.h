...
//    								variable from Object dictionary (index 0x1005). */
	...
	uint16_t index_in_cycle;		//<< Increase 1 when running Sync_process, reset when receiving sync pulse
	...
	uint32_t active_sync_mask[MAX_SYNC_SLOTS_x32];
};
